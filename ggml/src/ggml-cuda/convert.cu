...
static __device__ __forceinline__ void dequantize_f8_e4m3_b128(const void * __restrict__ vx, const int64_t ib, const int iqs, float2 & v) {
    const block_f8_e4m3_b128 * x = (const block_f8_e4m3_b128 *) vx;
    const float d = ggml_cuda_e8m0_to_fp32(x[ib].e);

    v.x = d * ggml_cuda_f8_e4m3fn_to_fp32(x[ib].qs[iqs + 0]);
    v.y = d * ggml_cuda_f8_e4m3fn_to_fp32(x[ib].qs[iqs + 1]);
}
...
to_fp16_cuda_t ggml_get_to_fp16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_F8_E4M3_B128:
            return dequantize_block_cont_cuda<QK_F8_E4M3_B128, QR_F8_E4M3_B128, dequantize_f8_e4m3_b128>;
        case GGML_TYPE_F32:
            return convert_unary_cont_cuda<float>;
        case GGML_TYPE_BF16:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_F8_E4M3_B128:
            return dequantize_block_cuda<QK_F8_E4M3_B128, QR_F8_E4M3_B128, dequantize_f8_e4m3_b128>;
        case GGML_TYPE_BF16:
